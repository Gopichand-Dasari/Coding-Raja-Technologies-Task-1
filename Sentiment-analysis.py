...
def predict_sentiment(sentence):
  ...
  sentence = cleaning_stopwords(sentence)
  sentence = cleaning_punctuations(sentence)
  sentence = cleaning_repeating_char(sentence)
  sentence = cleaning_URLs(sentence)

  # Transform the sentence into a feature vector
  feature_vector = vectoriser.transform([sentence])

  # Predict the sentiment using the classifier
  prediction = LRmodel.predict(feature_vector)
